    ...
    <Card premium glow="primary" className="flex flex-col justify-between group h-full">
      ...
      <div>
        <div className="flex items-baseline gap-1">
          ...
          <span className="text-sm font-black uppercase tracking-widest text-foreground/20 ml-2">Days</span>
        </div>
        <p className="text-foreground/40 text-[10px] font-black uppercase tracking-widest mt-1">Current Streak</p>
      </div>

      <div className="mt-8 pt-6 border-t border-foreground/5 flex items-center justify-center gap-4">
        <div className="flex-1">
          <p className="text-xl font-bold tracking-tight">{streaks.longest_streak}</p>
          <p className="stat-label">All-time Best</p>
        </div>
        <Trophy className="h-8 w-8 text-blue-500/20 shrink-0" />
      </div>
    </Card>
  )
}
